...
def sample_images(horse_loader, zebra_loader, epoch, generator_1, generator_2, path):
    ...
    save_image(result, os.path.join(path, 'CycleGAN_Horse2Zebra_Epoch_%03d.png' % (epoch + 1)), nrow=6, normalize=True)
