...
def train(batch_size, num_epochs):
    ...
    # Prepare Data Loader
    trainloader_horse, trainloader_zebra = get_horse2zebra_loader(batch_size, 'train')
    ...
    for epoch in range(num_epochs):
        for i, (horse, zebra) in enumerate(zip(trainloader_horse, trainloader_zebra)):
            ...
            ### Train Generator
            # Initialize Generator Optimization Function
            optim_G.zero_grad()
            ...
            # Mean Squared Error Loss (Transform Loss)
            fake_A = G_B2A(real_B)
            ...
            # Initialize Discriminator A Optimization Function
            optim_D_A.zero_grad()
            ...
            # Initialize Discriminator B Optimization Function
            optim_D_B.zero_grad()
        ...
        # Save Images
        sample_images(testloader_horse, testloader_zebra, epoch, G_A2B, G_B2A)

    make_gifs_sample(results_path, "CycleGAN")
